...
class HttpScreen : public Screen
{
  public:
    virtual void pre()
    {
      ...
      lv_label_set_text(btn1_label, "Roustaing");
      ...
      lv_label_set_text(btn2_label, "Hotel de ville");
      ...
      lv_label_set_text(btn3_label, "Gambetta");
      ...
      lv_label_set_text(btn4_label, "TV ON/OFF");
    }
