 ...
 *	which are to be set in bma421 sensor.
 *	@param[in] enable : Variable which specifies whether to enable or
 *	disable the features in the bma421 sensor
 *	enable		|	Macros
 *  --------------------|-------------------
 *	0x00		|  BMA4_DISABLE
 *	0x01		|  BMA4_ENABLE
 ...
 *	  - BMA421_STEP_CNTR
 *	  - BMA421_ANY_MOTION (or) BMA421_NO_MOTION
 *	  - BMA421_ACTIVITY
 *	  - BMA421_WAKEUP
 *	  - BMA421_TILT
 *
 ...
 *     platform  |   Macros
 *  -------------|------------------------
 *        0x00   | BMA421_PHONE_CONFIG
 *        0x01   | BMA421_WRIST_CONFIG
 *
 *  @param[in] dev : Structure instance of bma4_dev
 *  @return Result of API execution status
 *  @retval 0 -> Success
